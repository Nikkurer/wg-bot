...
COPY main.py config.py client_manager.py client_ownership.py client_list.py operator_add.py wg_admin_client.py service.py bootstrap.py users.py keyboards.py states.py status_format.py messages.py error_messages.py ./
